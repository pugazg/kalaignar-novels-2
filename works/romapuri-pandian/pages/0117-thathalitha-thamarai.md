...
- printed page 115 with work-title running header
- opens by completing scan116 continuation: `ஒலிபோலக்` → `கருடன் எழுப்பும் ‘ஙொய்’ என்ற ஒலி!`
- source-visible bird-call experiment, male-voice practice, spoken love-confession test, and terminal tactile/imaginative passage preserved
- source-sensitive `ஙொய்`, `பறவைகள்போல்`, `ஆண்களைப்போல்`, `பேசமுடியும்`, and hyphenated responsibility phrase retained for Pass2 review
- scan117 ends on a complete source sentence before blank physical scan118
