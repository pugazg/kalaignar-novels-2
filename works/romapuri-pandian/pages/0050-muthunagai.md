...
- visible printed page **48** and running header `கலைஞர் மு. கருணாநிதி`;
- opening `ஆபத்து வந்திருக்காதல்லவா?...` directly continues scan49 terminal `இந்த`;
- source-sensitive wording `அமளியை உருவாக்க` retained exactly.
...
- visible printed page — **48** at upper left;
- opens by completing scan49 sentence with `ஆபத்து வந்திருக்காதல்லவா?`.
